...
|---|---|---|---|---|---|---|---|
| This repository | working tree, v0.1.0 | No license granted; all rights reserved pending owner decision | n/a | Synthetic fixtures only; no speaker data | n/a | Not permitted | Local development only |
...
| Meta MMS collection/full training checkpoints | `facebook/mms-tts@44cc7fb408064ef9ea6e7c59130d88cac1274671` | The MMS-specific README states CC BY-NC 4.0 for MMS code and weights; the surrounding Fairseq repository is MIT | CC BY-NC 4.0 | MMS paper describes a dataset based on readings of publicly available religious texts. Source-recording rights are not itemized per TTS checkpoint in the model card; treat lineage as non-commercial and incomplete for commercial clearance. | No project claim that raw outputs are automatically relicensed; project use remains non-commercial and speaker consent independently controls voice/sample/demo use. | Attribution required; commercial use prohibited; project weights blocked until explicit distribution consent | Approved only as source for local discriminator conversion after checksum capture |
| MMS Vietnamese initialization | `facebook/mms-tts-vie@b58928d033932a49aa8e3d6cf11625b25fe928d2` | Transformers runtime Apache-2.0 | CC BY-NC 4.0 | Same MMS lineage above. Vietnamese tonal/Latin transfer to White Hmong is an unproven initialization hypothesis **[NV]**. | Research/non-commercial project scope; voice consent still required for derived outputs | Fine-tuned derivatives treated as CC BY-NC 4.0; no distribution assumed | Approved for local inference and plan-defined A/B pilot only |
| MMS English control initialization | `facebook/mms-tts-eng@c71de0fe7204c83f1c10820a7d696d0b450048ba` | Transformers runtime Apache-2.0 | CC BY-NC 4.0 | Same MMS lineage above | Same as Vietnamese initialization | Fine-tuned derivatives treated as CC BY-NC 4.0; no distribution assumed | Approved for local inference and plan-defined A/B pilot only |
